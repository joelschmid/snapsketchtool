...
namespace WindowsFormsApplication1
{
    public partial class FormZoom : Form
    {
        ...
        /**
        * This Method will be called by mouse down
        ...
        */
        private void pictureBox1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            Image DrawImage = manager.DrawMouse(Original, Second, e.X,e.Y, color, size);
           ...
           //check if the path is set
            if (!string.IsNullOrEmpty(textBox3.Text)&&!textBox3.Text.Equals("Name mandatory"))
            {
                ...
                if (fd.SelectedPath != null)
                {
                    ...
                    Image savePicture = pictureBox1.Image;
        ...
        */
        ...
        private void btLoad_Click(object sender, EventArgs e)  // Open File
        {
            ...
            //Open the picture
            pictureBox1.Image = manager.OpenPicture(PathToImage); ;

            //save copy
            Image copy = pictureBox1.Image;

            //Resize the picture
            pictureBox1.Image = manager.ResizeImage(copy, new Size(800, 400));

            //save backup
            this.Backup = manager.ResizeImage(copy, new Size(800, 400));
